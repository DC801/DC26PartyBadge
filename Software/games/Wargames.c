 ...
 */
void wg_GotString(char *string, uint8_t len){
...
void wg_Unlock(void){
    ...
    wg_SendString(ESCAPE"[0;4;5m");
    wg_SendString("SCORE MODIFIER UNLOCKED");
    wg_SendString(ESCAPE"[0m");
