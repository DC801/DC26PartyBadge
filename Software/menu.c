...
void drawScreenTemplate(void){
    ...
    util_gfx_fill_rect(0, 0, GFX_WIDTH, 40, COLOR_BLACK);
    ...
    util_gfx_set_cursor(GFX_WIDTH - w - 1, 32);
    util_gfx_print(modifier);

    util_gfx_draw_line(0, 40, GFX_WIDTH, 40, COLOR_WHITE);
}
